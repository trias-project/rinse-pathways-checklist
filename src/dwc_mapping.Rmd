...
For certain taxa, we will complement this pathway information with the specifc vector of introduction (contained in columns starting with `raw_vector_`), using the **subcategories** of the CBD standard:
